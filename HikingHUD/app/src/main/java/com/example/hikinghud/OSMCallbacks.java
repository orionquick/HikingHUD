...
public class OSMCallbacks implements Response.Listener<String>, Response.ErrorListener {
    ...
    public OSMCallbacks(MainActivity.ReqType t, Context c)
    {
        type = t;
        ourContext = c;
    }
    ...
    public void onResponse(String response)
    {
        ...
        MainActivity.view.setText("Response is: "+ MainActivity.sources.get(0).nodesID);

        MainActivity.findClosestWater(32.88186, -117.23414);
